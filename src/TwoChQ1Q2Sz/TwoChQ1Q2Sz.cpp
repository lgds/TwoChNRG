...
int main (){
  ...
  CNRGbasisarray AeigCut(3);

  CNRGbasisarray Abasis(3);
...
//////////////////////////
  ...
  TwoChQ1Q2Sz_SetSingleSite(&SingleSite);
  ...
  TwoChQ1Q2Sz_SetH0Anderson(Params,&SingleSite,&Aeig,&Abasis);

  Aeig.PrintEn();

  // Calculate Susceptibility - Adapt that to a more general case!!
  ...
  if ( (calcdens==2)||(calcdens==3) )
    {
      ...
      Sus=CalcSuscep(Params,&Aeig,2,false);
      double Sus0=0.0;
      int nlines=0;
      if (calcdens==2)
	{
  ...
  TwoChQ1Q2Sz_UpdateQm1fQ(&SingleSite,&Aeig,&Abasis,Qm1fNQ);
  ...
  while (Nsites<=Nsitesmax)
    {
      ...
      if ( (UpdateBefCut==0)&&(Nsites>0) )
	{
	  cout << "Updating matrices after cutting... " << endl;    
	  TwoChQ1Q2Sz_UpdateMatrixAfterCutting(&SingleSite,
      ...
      TwoChQ1Q2Sz_DiagHN(Params,&Abasis,&SingleSite,Qm1fNQ,&Aeig);
